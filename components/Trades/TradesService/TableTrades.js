...
import LookTrade from "./ViewDetailTrade";
...
const TableTradesServices = () => {
  ...
  const searchByEmail = () => {
    ...
    fetch(`${API}/canjesService/email/${emailSearch}`, {
      method: "GET",
      headers: headers,
    })
      // We get the API response and receive data in JSON format...
  ...
  const sendChanges = async (trade) => {
    ...
    await fetch(`${API}/canjeService/${trade._id}`, {
      method: "PUT",
      headers: headers,
...
export default TableTradesServices;
