        ...
        React.useEffect(() => {
          ...
          if(options_subcategory.length){
            const categories = options_subcategory[0].categories
             object_subcategories = categories.filter(subcategory => subcategory.name === typeDescription)
          ...
          if(options_subcategory.length && object_subcategories.length && typeDetailCategory){
        ...
        <div>
            ...
            <ModalBody>
              ...
              <FormControl style={{width: '100%', marginTop: '15px'}}>
                <InputLabel id="label-brand" style={{transform: 'translate(0, 0px) scale(0.8)'}}>Marca del producto</InputLabel>
                <Select
                    value={brand}
                    labelId="label-brand"
              ...
              <FormControl style={{width: '100%', marginTop: '15px'}}>
                <InputLabel id="label-petType" style={{transform: 'translate(0, 0px) scale(0.8)'}}>Tipo de mascota</InputLabel>
                <Select
                    value={petType}
              ...
              <FormControl style={{width: '100%', marginTop: '15px'}}>
                <InputLabel id="label-category" style={{transform: 'translate(0, 0px) scale(0.8)'}}>Categoría del Producto</InputLabel>
                <Select
                    value={category}
              ...
              <FormControl style={{width: '100%', margin: '15px 0px'}}>
                <InputLabel id="label-subcategoria" style={{transform: 'translate(0, 0px) scale(0.8)'}}>SubCategoria del Producto</InputLabel>
                <Select
            ...
            <ModalFooter>
              <Button color="primary" onClick={() => addProduct()}>Guardar Cambios</Button>
